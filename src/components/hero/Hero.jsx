...
const Hero = () => {
  ...
  return (
    <Carousel className="carousel">
      ...
      <Carousel.Item>
        <img src={IMAGE_LINK+upcommingMovies[0]?.backdrop_path} alt="First slide" className="img" />
        <Carousel.Caption>
      ...
      <Carousel.Item>
        <img src={IMAGE_LINK+upcommingMovies[1]?.backdrop_path} alt="First slide" className="img" />
        <Carousel.Caption>
      ...
      <Carousel.Item>
        <img src={IMAGE_LINK+upcommingMovies[2]?.backdrop_path} alt="First slide" className="img"/>
        <Carousel.Caption>
